...
class MoverHandler(FileSystemEventHandler):
    ...
    # def check_rar_files(self, entry, name): # * Checks all RAR Files
    #     for rar_extention in rar_extentions:
    #         if name.endswith(rar_extention) or name.endswith(rar_extention.upper()):
    ...
    #             move_file(exe_extention, entry, name)
